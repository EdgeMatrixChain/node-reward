...
describe("NodeStakeNativeV1 Contract Test", function () {
  ...
  async function deployContractFixture() {
    ...
    const nodeStake = await hre.ethers.deployContract("NodeStakeNativeV3", [scheduleRelease, manager, days1080RewardRate, 36, "Staking Token", "STST"]);
  ...
  it("Should withdrw 75% token by the staker who deposit", async function () {
    ...
    const { nodeStake, scheduleRelease, owner, staker1, staker2, manager, test1, test2, stakingToken } = await loadFixture(
      deployContractFixture
    );
